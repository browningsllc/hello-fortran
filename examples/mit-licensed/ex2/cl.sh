...
# Filename: cl.sh
# Purpose: Remove the build products and generated output for the ex2 example.
...
# Delete the comment-stripped copy of the input file written by the program
#   Only the generated *.clean file is removed; the *.txt input is untouched
rm -f -- *.clean
