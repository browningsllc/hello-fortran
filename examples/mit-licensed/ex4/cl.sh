...
# Filename: cl.sh
# Purpose: Remove the build products and generated output for the ex4 example.
...
# Delete the report file written by the program
#   Only the generated *.out file is removed; the *.nml input is untouched
rm -f -- *.out
